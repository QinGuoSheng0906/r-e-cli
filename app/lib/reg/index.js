const trim = /(^\s*)|(\s*$)/g // 清楚前后空格
const phone = /^[1][3-9][0-9]{9}$/ // 验证手机号
const number = /^[0-9]*[1-9][0-9]*$/ // 判断是否是数字
const number1 = /^[1-9][0-9]*([.][0-9]+)?$/ // 带小数点
const letterChinese = /^[a-zA-Z\u4e00-\u9fa5]+$/ // 英文和中文字母
const letterNumChinese = /^[a-zA-Z0-9\u4e00-\u9fa5]+$/ // 英文、数字和中文字母
let email = /()/
// 车牌
